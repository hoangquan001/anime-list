...
export default function SeasonNowPage() {
  ...
  useEffect(() => {
    const fetchCurrentSeason = async () => {
      ...
      try {
        ...
        const response = await seasonsClient.getSeasonNow({
          page: page,
          limit: 25
        })
        ...
        setError('Không thể tải danh sách anime đang phát sóng. Vui lòng thử lại sau.')
      } finally {
        setLoading(false)
      }
    }
  ...
  const getCurrentSeason = () => {
    ...
    return `${seasonNames[season as keyof typeof seasonNames]} ${currentYear}`
  }
        ...
        <div className="bg-white shadow-sm">
          <div className="container mx-auto px-4 py-8">
            <nav className="mb-6">
              ...
              <span className="mx-2 text-gray-400">/</span>
              <span className="text-gray-700">Đang phát sóng</span>
            </nav>
            
            <div className="text-center">
              <h1 className="text-4xl font-bold text-gray-800 mb-4">📺 Anime đang phát sóng</h1>
              <p className="text-lg text-gray-600">
                {getCurrentSeason()} - Những anime hot nhất hiện tại
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-xl p-6 shadow-md mb-8">
          <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
            <div>
              <h2 className="text-2xl font-bold text-gray-800 mb-2">Anime hiện tại</h2>
              {pagination && (
        ...
        {animeList.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="text-gray-600">Không có anime nào đang phát sóng.</p>
          </div>
        ) : (
          <>
            <GridLayout cols={{ sm: 2, md: 3, lg: 4, xl: 5 }}>
